    ...
    return (
        <div className='login-content d-flex align-items-center'>
            <form className="form-signin mx-auto">
                ...
                <button className="btn btn-lg btn-block btn-login my-2" type="submit">Sign in</button>
                <div className='msg-login text-white text-center my-5'>
                    <span><strong>WOW! </strong>Voce esta conectado! &#128526;</span>
                    <br></br>
                    <span><strong>Ops! </strong>Verifique se a senha ou usuario estao corretos! &#128546;</span>
                </div>
